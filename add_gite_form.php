...
?>
    <div class="main-container mt-3">
        ...
        <form action="add_gite_form.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <br />
                <input class="btn btn-outline-success" type="file" id="img_gite" name="img_gite" accept="image/png, image/jpeg, image/svg">
            </div>
