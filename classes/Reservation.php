...
class Reservation
{
    public function reserverGite(){
        ...
        try {
            ...
            $query = "SELECT * FROM gites INNER JOIN category_gites ON gites.gite_category = category_gites.id WHERE gites.id = ? ";
            ...
            while ($datas = $req->fetch()) {
                ...
                $url = "http://localhost/poo-gites/confirmation_reservation.php?id=$emailId";
                //Contenus du mail
                $mail->Body = '
    <!DOCTYPE html>
    <html>
    ...
    <div style="padding: 20px;">
        ...
        <p>Nom du gite :<b style="color: yellow">'.$datas['nom_gite'].'</b></p>
        <p>Description du gite :<b style="color: yellow"> '.$datas['description_gite'].'</b></p>
        <p>Image du gite :<img src="'.$datas['img_gite'].'"/></p>
        <p>Prix par semaine du gite :<b style="color: yellow"> '.$datas['prix'].' €</b></p>
        <p>Nombre de chambre :<b style="color: yellow"> '.$datas['nbr_chambre'].'</b></p>
        <p>Nombre de salle de bain :<b style="color: yellow"> '.$datas['nbr_sdb'].'</b></p>
        <p>Zone géographique :<b style="color: yellow"> '.$datas['zone_geo'].'</b></p>
        <p>Date arrivée :<b style="color: yellow"> '.$datas['date_arrivee'].'</b></p>
        <p>Date départ :<b style="color: yellow"> '.$datas['date_depart'].'</b></p>
        <p>Description du gite :<b style="color: yellow"> '.$datas['type'].'</b></p>
    ...
    ';
            ...
            header("http://localhost/poo-gites/confirmation_reservation.php?id=$emailId");
        }catch (Exception $e){
